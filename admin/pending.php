...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] != true )
{
    ...
    $_SESSION['pending'] = mysql_num_rows($result);
...
<body class="w3-light-grey" >
                ...
                <!-- <div class="w3-dropdown-click">
                    <button class="w3-button" onclick="myfunction()">Complaints</button>
                        <div id="Demo" class="w3-dropdown-content w3-bar-block w3-border">
                                ...
                                <a href="pending.php" class="w3-bar-item w3-button w3-green">Pending</a>
        ...
        <div style="margin-left:17%;margin-top:20px;margin-right:10%">
            ...
            <hr>
            <div class="w3-container" style="width: 50%; margin-left: 40%;"><h3>Pending Complaints</h3></div>
            <hr>
        <div class="w3-container">
            <b><u><p>Number of complaints: <?php echo $_SESSION['pending'] ?></p></u></b>
        </div>
