...
<div style="margin-left:17%;margin-top:20px;">
        ...
        <div style="margin-left:17%;margin-top:20px;margin-right:10%">
                ...
                <div class="w3-container w3-center">
                    <u><h2><a href="admin_dash.php">Dashboard</a></h2></u> 
                </div>
           ...
           <div class="w3-container w3-card-4 w3-center" style="width:50%;margin-left:30%;">
                    
                    <div class="w3-container" style="padding:25px;width:100%;">
                            <div class="w3-dropdown-hover" style="width:50%;margin:auto;">
                                <button class="w3-button w3-blue w3-xlarge w3-round-large" style="width:100%;align:center;">All Complaints</button>
                                    <div class="w3-dropdown-content w3-card-4" >
                                        <div class="w3-container">
                                            <p> 
                                                <!-- Page under Construction -->
                                                <?php 
                                                    $query1 ="SELECT * from newcomplaint";
                                                    $inter1 = mysql_query($query1);
                                                    // $res1 = mysqli_query($query1,$con);
                                                    $num1 = mysql_num_rows($inter1);
                                                    echo $num1;
                                                    // echo $num1;
                                                ?> 
                                            </p>
                    ...
                    <div class="w3-container" style="padding: 25px">
                        <div class="w3-dropdown-hover" style="width:50%;margin:auto;">  
                            <button class="w3-button w3-red w3-xlarge w3-round-large" style="width:100%;align:center;">Pending</button>
                                <div class="w3-dropdown-content w3-card-4" >
                                                <div class="w3-container">
                                                    <p>
                                                        <!-- Page under Construction -->
                                                        <?php 
                                                         $query2 = mysql_query("SELECT * from pending");
                    ...
                    <div class="w3-container" style="padding:25px">
                        <div class="w3-dropdown-hover" style="width:50%;margin:auto;">  
                                <button class="w3-button w3-green w3-xlarge w3-round-large" style="width:100%;align:center;">Solved</button>
                                <div class="w3-dropdown-content w3-card-4" >
                                                <div class="w3-container">
                                                    <p>
                                                        <!-- Page under Construction -->
                                                        <?php 
                                                         $query3 = mysql_query("SELECT * from solved");
